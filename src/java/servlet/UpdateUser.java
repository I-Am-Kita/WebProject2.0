...
public class UpdateUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String new_initials = request.getParameter("initials");
            ...
            String msg = userRepository.updateUser(nic_no,new_initials,new_surname,new_tel_no,new_email,passwordEnc);
